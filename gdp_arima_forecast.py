...
# Clean column names and set up the time series
...
# Convert 'Year' to proper datetime index and filter from 1970
...
# Create a new datetime index with the same length as the data
